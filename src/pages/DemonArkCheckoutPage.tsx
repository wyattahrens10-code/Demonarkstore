...
export default function DemonArkCheckoutPage() {
  ...
  },[duplicateDemonVipSubscription,acceptedTerms,store,requiredIdentifiers,identifierValues,discordTag,selectedServer,items,addToast,token,apiBaseUrl,vipStatus]);
